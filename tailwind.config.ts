    ...
    extend: {
      ...
      colors: {
        ...
        youtube: {
          ...
          chip: "hsl(var(--youtube-chip))",
          "chip-active": "hsl(var(--youtube-chip-active))",
          "chip-text": "hsl(var(--youtube-chip-text))",
          "chip-active-text": "hsl(var(--youtube-chip-active-text))",
          divider: "hsl(var(--youtube-divider))",
          icon: "hsl(var(--youtube-icon))",
